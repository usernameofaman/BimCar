...
const EnhancedTableToolbar = (props) => {
    ...
    return (
        ...
        >
            ...
            <a style={{ textDecoration: "none", color: "black" }} href='/dashboard/add-car-acquisition'>
...
export default function EnhancedTable() {
    ...
    useEffect(() => {
        let data = localStorage.getItem("carAcquisition")
        if (data)
            setTableData(JSON.parse(data))
        else
            localStorage.setItem("carAcquisition", JSON.stringify(mainData))
    }, [])
    ...
    const showCarDetails = (id) => {
        window.location.pathname = `/dashboard/edit-car-acquisition/${id}`
    }
    ...
    return (
        <Box sx={{ width: '100%' }}>
            ...
            >
                ...
                <MenuItem onClick={() => moveToCarMaster(selectedId)}>Move To Car Master</MenuItem>
